...
future_obs_index=5 # should be consistent with the data config, e.g., future_obs_index=5 means using the observation at t+5 as the future observation for training
