...
@dataclass
class PiModelOutput(ModelOutput):
...
class PiPolicy(BasePolicy):
    def __init__(
        ...
        **model_cfg: DictConfig,
        ...
        # TODO: enable load pretrained encoder
    ...
    def sample_fm_time(self, bsz: int) -> torch.FloatTensor:
        if self.flow_sampling == "uniform":  # uniform between 0 and 1
            ...
            t = 1 - self.flow_t_max * (1 - z)  # flip and shift
        return t
    ...
    def forward(
        ...
        if inference_mode:
            ...
            return self.forward_train(
                ...
                action_dim_is_pad = batch["action_dim_is_pad"] if "action_dim_is_pad" in batch else None,
                proprio = batch["proprio"],
            )
