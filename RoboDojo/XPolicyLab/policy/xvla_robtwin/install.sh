...
print("[xvla_robtwin] dependency versions:", versions)
print("[xvla_robtwin] torch CUDA runtime:", torch.version.cuda)
print("[xvla_robtwin] CUDA available:", torch.cuda.is_available())
if torch.cuda.is_available():
    print("[xvla_robtwin] GPU:", torch.cuda.get_device_name(0))
'

echo "[xvla_robtwin] Installed shared X-VLA runtime in conda env ${CONDA_ENV}."
echo "[xvla_robtwin] Model directory: ${POLICY_DIR}/checkpoints/shared/X-VLA-RoboTwin2"
