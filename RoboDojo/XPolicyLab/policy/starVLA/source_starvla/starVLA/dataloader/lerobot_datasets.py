...
def make_LeRobotSingleDataset(
    ...
    data_cfg_for_dataset = data_cfg
    modality_key_ranges = getattr(data_config, "modality_key_ranges", None)
    if modality_key_ranges is not None:
        data_cfg_for_dataset = dict(OmegaConf.to_container(data_cfg, resolve=True)) if data_cfg else {}
        data_cfg_for_dataset["modality_key_ranges"] = modality_key_ranges

    video_backend = data_cfg_for_dataset.get("video_backend", "decord") if data_cfg_for_dataset else "torchvision_av"
