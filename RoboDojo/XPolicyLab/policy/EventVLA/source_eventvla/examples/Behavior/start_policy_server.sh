...
# Debug: Print the currently used Python environment
echo "Using Python: $(which python)"

# setrequired environment variables
export star_vla_python=/data/wzx/conda_env/eventvla/bin/python
...
# Check whether the server started successfully
