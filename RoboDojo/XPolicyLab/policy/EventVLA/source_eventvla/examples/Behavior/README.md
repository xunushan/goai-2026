...
2. Running the evaluation by launching services in both `eventvla` and `behavior` environments.  
...
- `star_vla_python`: Python interpreter for the EventVLA environment.
