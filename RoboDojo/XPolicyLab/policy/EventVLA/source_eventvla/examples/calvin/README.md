...
This document describes how to **train and evaluate EventVLA models on the Calvin benchmark**, including dataset preparation, training configuration, and evaluation procedures.
...
### Step 1. Launch Policy Server (EventVLA Environment)

In the first terminal, activate the `eventvla` conda environment and start the inference server:
