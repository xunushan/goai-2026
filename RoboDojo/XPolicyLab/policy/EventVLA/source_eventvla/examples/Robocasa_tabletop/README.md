...
2. Running the evaluation by launching services in both `eventvla` and `robocasa` environments.  
...
- [Qwen3VL-GR00T](https://huggingface.co/EventVLA/Qwen3-VL-GR00T-Robocasa-gr1)
- [Qwen3VL-OFT](https://huggingface.co/EventVLA/Qwen3-VL-OFT-Robocasa)
...
your_ckpt=EventVLA/Qwen3-VL-OFT-Robocasa/checkpoints/steps_90000_pytorch_model.pt
