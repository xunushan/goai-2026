...
# Modification: [rm and add some connect adapter to match with eventvla, e.g., "rm "].
...
from eventvla.model.modules.action_model.flow_matching_head.action_encoder import (
    SinusoidalPositionalEncoding,
    swish,
)

from eventvla.model.modules.action_model.flow_matching_head.cross_attention_dit import DiT, SelfAttentionTransformer
...
class LayerwiseFlowmatchingActionHead(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        # update DiTConfig to diffusion_model_cfg
