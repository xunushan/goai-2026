...
from eventvla.model.modules.action_model.VLA_AdapterHeader import get_action_model, VLA_Adapter_L1RegressionActionHead
...
from eventvla.model.modules.vlm.QWen3 import IMAGE_TOKEN_INDEX, VIDEO_TOKEN_INDEX
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./eventvla/config/training/starvla_train_adapter.yaml", help="Path to YAML config")
