...
Note: How to add special tokens to Qwen2.5:
  download our model checkpoint with special tokens added: https://huggingface.co/EventVLA/Qwen2.5-VL-3B-Instruct-Action
"""
...
from eventvla.model.modules.action_model.fast_ActionHeader import get_action_model
...
if __name__ == "__main__":
    ...
    args.config_yaml = "./examples/RoboTwin-Mem/train_files/starvla_cotrain_robotwin.yaml"
