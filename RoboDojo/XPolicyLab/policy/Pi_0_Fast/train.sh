...
# LeRobot repo produced by process_data.py (repo_id=<bench>-<ckpt>-<env>-<action>);
# override --data.repo-id so training does not fall back to the config default.
...
echo "[Pi_0_Fast] lerobot_repo_id=${lerobot_repo_id}"
