...
if __package__:
    ...
    # Direct-script compatibility without allowing xvla/datasets to shadow
    # Hugging Face's top-level datasets package inside LeRobot.
...
def main(args):
    ...
    if model.action_mode != "arx_ee6d":
        raise ValueError(
            "RoboDojo LeRobot training requires action_mode='arx_ee6d'; "
            f"got {model.action_mode!r}."
        )
